...
class ReviewAdapter(private val MyDataset: Array<String>): RecyclerView.Adapter<ReviewAdapter.ReviewViewHolder>() {
    ...
    class ReviewViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        fun bindItem(data : String, ctx : Context) {
            ...
            Glide.with(ctx).load(product2).into(itemView.productImg)
        }
    }
